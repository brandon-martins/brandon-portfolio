...
const STATUS_META = {
	...
	internal: {
		label: 'Internal',
		colour: 'text-muted border-border bg-surface',
	},
	archived: {
		label: 'Archived',
		colour: 'text-dim   border-border bg-surface',
	},
};
			...
			<div className="max-w-6xl mx-auto px-4 sm:px-8">
				<FadeIn className="mb-14">
					...
					<p className="text-muted mt-3 max-w-130">
						A selection of projects spanning enterprise banking, NGO systems,
						and commercial web development.
					</p>
				</FadeIn>
				...
				<FadeIn className="flex flex-wrap items-center justify-between gap-4 p-5 md:p-6 rounded-sm border border-dashed border-border">
					<div>
						<div className="font-mono text-muted text-[0.72rem] tracking-[0.06em] mb-1">
							More work available at
						</div>
						<div className="font-display font-bold text-accent text-[1.1rem]">
							www.webify.org.za
						</div>
					</div>
					<a
					...
					>
						Visit Webify <ArrowRight className="w-4 h-4" />
					</a>
				</FadeIn>
			</div>
		</section>
