export const personal = {
  ...
  tagline: 'Building robust digital products for South African businesses — from architecture to deployment.',
...
export const skills = {
  ...
  'Back-End': ['PHP', 'Java', 'Node.js', 'C#', 'JSP'],
...
export const certifications = [
  { name: 'AWS — Computer Foundations: Security', issuer: 'Amazon Web Services', year: '2025' },
  { name: 'AWS — Computer Foundations: Storage & Databases', issuer: 'Amazon Web Services', year: '2025' },
...
export const projects = [
  {
    ...
    description: 'Corporate website for a security services firm — custom-built, responsive, and brand-aligned.',
    year: '2021',
    tags: ['Web Development', 'UI Design', 'Responsive'],
  },
  {
    name: 'DigiView NPO Registration & Login System',
    description: 'Full-stack system for NGO/NPO registration management, built for Bridgeway Communications.',
    year: '2021',
    tags: ['Full Stack', 'PHP', 'MySQL', 'Java'],
  },
  {
    name: 'End-User Computer Training Module',
    description: 'Java-based training application developed for enterprise use at Bridgeway Communications.',
    year: '2018',
    tags: ['Java', 'Enterprise', 'Training Tech'],
  },
  {
    name: 'SBG Customer 1st Application',
    description: 'Customer-centric banking application at Standard Bank, built for Mobile and Internet Banking channels.',
    year: '2014',
...
export const services = [
  { title: 'Web Development', desc: 'Custom-built, scalable, secure websites optimised for performance.' },
  { title: 'Web Design', desc: 'Creative, responsive designs that reflect your brand identity.' },
  { title: 'E-commerce Solutions', desc: 'Robust online stores driving sales and seamless shopping experiences.' },
  { title: 'SEO & Digital Marketing', desc: 'Strategies to improve online visibility and attract quality traffic.' },
  { title: 'Progressive Web Apps', desc: 'PWAs that deliver app-like experiences across all devices.' },
  { title: 'Maintenance & Support', desc: 'Ongoing support to keep your site current, secure, and running smoothly.' },
];
